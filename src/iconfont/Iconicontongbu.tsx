...
let Iconicontongbu: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconicontongbu.defaultProps = {
  size: 18,
};

Iconicontongbu = React.memo ? React.memo(Iconicontongbu) : Iconicontongbu;

export default Iconicontongbu;
