...
Iconzhiyudingceng.defaultProps = {
  size: 18,
};

Iconzhiyudingceng = React.memo ? React.memo(Iconzhiyudingceng) : Iconzhiyudingceng;

export default Iconzhiyudingceng;
