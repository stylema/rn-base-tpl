...
Iconzhiyudiceng.defaultProps = {
  size: 18,
};

Iconzhiyudiceng = React.memo ? React.memo(Iconzhiyudiceng) : Iconzhiyudiceng;

export default Iconzhiyudiceng;
