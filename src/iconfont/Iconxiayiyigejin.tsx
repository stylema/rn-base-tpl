...
let Iconxiayiyigejin: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconxiayiyigejin.defaultProps = {
  size: 18,
};

Iconxiayiyigejin = React.memo ? React.memo(Iconxiayiyigejin) : Iconxiayiyigejin;

export default Iconxiayiyigejin;
