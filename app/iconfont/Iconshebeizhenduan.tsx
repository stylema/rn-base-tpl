...
let Iconshebeizhenduan: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconshebeizhenduan.defaultProps = {
  size: 18,
};

Iconshebeizhenduan = React.memo ? React.memo(Iconshebeizhenduan) : Iconshebeizhenduan;

export default Iconshebeizhenduan;
