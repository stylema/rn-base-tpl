...
let Iconshangyiyigejin: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconshangyiyigejin.defaultProps = {
  size: 18,
};

Iconshangyiyigejin = React.memo ? React.memo(Iconshangyiyigejin) : Iconshangyiyigejin;

export default Iconshangyiyigejin;
